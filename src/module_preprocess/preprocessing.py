...
class DictionaryGenerator:
    ...
    def build_or_update_dictionary(self, chunk_size=50, save_path="term_mapping_dict.json"):
        ...
        if new_candidates:
            ...
            3. 문맥 기반 추론: 매핑 결과를 도출할 때는 반드시 [강의 세션 주제 정보]의 내용을 최우선 힌트로 삼아, 주제와 연관된 전문 용어를 추론하세요.
            4. 표준어 표기 원칙: 매핑되는 표준 IT 용어는 공식적인 영문 대소문자 표기를 따르세요.
            5. 노이즈 철저 배제: 일반 명사(사과, 책상), 숫자(1번, 100), 강의 진행용어(진행, 결과, 질문)는 결과에 절대 포함하지 마세요.
